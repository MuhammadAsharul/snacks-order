<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li
            class="menu-item {{ request()->is('admin/category') || request()->is('admin/add-category') ? 'active' : '' }}">
        ...
        <!-- Product -->
        <li
            class="menu-item {{ request()->is('admin/product') || request()->is('admin/add-product') ? 'active' : '' }}">
            <a href="javascript:void(0)" class="menu-link menu-toggle">
        ...
        <!-- Forms -->
        <li
            class="menu-item {{ request()->is('cetak-order-form') || request()->is('cetak-product-form') ? 'active' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-detail"></i>
                <div data-i18n="Form Elements">Rekap</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item  {{ request()->is('cetak-order-form') ? 'active' : '' }}">
                    <a href="{{ route('cetak-order-form') }}" class="menu-link">
                        <div data-i18n="Basic Inputs">Cetak Rekap Penjualan</div>
                    </a>
                </li>
                <li class="menu-item  {{ request()->is('cetak-product-form') ? 'active' : '' }}">
