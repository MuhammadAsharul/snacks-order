...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page / </span>Rekap Product</h4>
        <div class="card">
            <h5 class="card-header">Cetak Rekap Product</h5>
            <div class="row">
                <div class="card-header">
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            <a href=""
                                onclick="this.href='/cetak-product-bydate/'+document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value"
